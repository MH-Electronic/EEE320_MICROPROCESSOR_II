...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../MicroP.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x15098
SOPC_SYSID_FLAG += --sidp=0x15098
ELF_PATCH_FLAG  += --sidp 0x15098

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1737288382
SOPC_SYSID_FLAG += --timestamp=1737288382
ELF_PATCH_FLAG  += --timestamp 1737288382
